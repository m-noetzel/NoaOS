...
| FR1-L1 | Low | `_check_thread_domain` (chat.py:270) is fail-open when DB session raises exception — domain check silently bypassed, existing thread may be accessed from wrong mode | Open | — |

**Open:** 36 | **Partially Resolved:** 0 | **Resolved:** 115 | **Total:** 151
