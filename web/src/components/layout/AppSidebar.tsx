    ...
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <div className="flex items-center gap-2.5 px-2 py-1.5">
          {/* UX-L1: flex-shrink-0 prevents logo from squeezing when sidebar toggles */}
          <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-xl gradient-primary shadow-md glow-sm">
